...
- triggered_areas: assess against these regulatory areas specifically — DLG (Digital Lending Guidelines), KYC_AML (KYC Master Direction / AML), and PPI (Prepaid Payment Instruments). For each, state whether it is triggered, not_triggered, or not_applicable, give a one-sentence reason grounded in the description, and list signals: an array of short, specific phrases naming exactly what in the description triggered (or failed to trigger) this area — e.g. ["digital onboarding detected", "NBFC partnership detected", "digital loan disbursal detected", "instant lending workflow detected"]. Empty array only if truly nothing in the description bears on this area.
